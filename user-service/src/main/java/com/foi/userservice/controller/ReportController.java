...
public class ReportController
{
            ...
            final String date, final Model model)
    {
        ...
        System.out.println("ReportController linija 53");
        //        transactionEntityList = transactionFacade.findByUserAndChosenMonth(
            ...
            final String year, final Model model)
    {
        ...
        System.out.println("ReportController linija 98");
        //        transactionEntityList = transactionFacade.findByUserAndChosenYear(
        //                userFacade.getUserEntity(),
        //                year
        //        );
        if (!transactionEntityList.isEmpty())
